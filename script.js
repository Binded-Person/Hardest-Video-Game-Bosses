...
if (darkButton) {
    darkButton.addEventListener("click", function() {
        ...
        if (nextArrow) {
            nextArrow.classList.toggle("darkimage");
        }
        let backArrow = document.getElementById("back-arrow");
        if (backArrow) {
            backArrow.classList.toggle("darkimage");
        }
    });
...
function randomizeBoss() {
    ...
    document.getElementById("randomBoss").innerText = "Your Opponent is: " + bosses[randomIndex];
}
...
function rateBoss() {
    ...
    if (rating>= 8) {
        document.getElementById("bossRating").innerText = "You think this boss is very difficult!";
    } else if (rating >= 5) {
        document.getElementById("bossRating").innerText = "You think this boss is moderately difficult.";
    } else {
        document.getElementById("bossRating").innerText = "You think this boss is pretty easy!";
    }
}
